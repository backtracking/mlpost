...
%TODO? : expliquer le fonctionnement principal de \mlpost : construction d'un
%         AST \metapost, qui est dumpé dans un fichier .mp => déroulement de
%         l'algo, pas de compilation
