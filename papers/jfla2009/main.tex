...
et 2 cm pour $B$. Cependant, si vous changez d'avis sur le contenu de
...
\medskip\noindent
On utilise ici le symbole infixe \texttt{++} qui permet de concaténer
des commandes de dessin plus efficacement qu'en utilisant l'opérateur
\texttt{@} de \ocaml.
On utilise d'autre part \texttt{bp}, qui est une unité propre à
\metapost, proche du point \postscript.
...
allant du bord d'une boîte au  bord d'une autre boîte. Ce chemin est
