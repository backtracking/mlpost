...
marges séparant le contenu du contour de la boîte. Elles prennent
également un argument \texttt{name} permettant de nommer les boîtes
pour y accéder plus tard.

\paragraph{Diagrammes de classes.}
Avec la fonction \texttt{Box.vblock} introduite ci-dessus, il est facile
...
% TODO implémentation des boites
...
% TODO expliquer le code de Tree -- JCF
