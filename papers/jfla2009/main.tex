...
\begin{itemize}
\item Le type abstrait \texttt{body}  décrit le corps des flèches, qui
...
Voyons d'abord  comment on  peut émuler les  flèches de  \metapost. On
part d'un  corps vide et  on lui ajoute  un trait normal sur  toute la
longueur.  On ajoute une tête triangulaire remplie, et on obtient :
