...
% TODO dispo à \url{http://mlpost.lri.fr}
...
% contribution scientifique : qu'est-ce que garantie le typage d'ocaml
% par rapport à une utilisation directe de metapost ? absence d'erreur
% à l'exécution, par exemple ?

% mlpost = langage déclaratif au dessus de metapost = langage
% impératif / déclaratif

% TODO : séparer points / vecteurs
...
construction de programmation de haut-niveau etc.  
