...
marge entre le contenu de la boîte et son contour. Le paramètre
\texttt{stroke} permet de spécifier si (et dans quelle couleur) le
contour doit être tracé. Notez que les fonctions \texttt{Box.tex} et
\texttt{Box.box} prennent un argument \texttt{name} permettant de
